...
inline void nam::ColliderSystem::CheckCollision(TransformComponent& transform1, TransformComponent& transform2, BoxType1& box1, BoxType2& box2, u32 entity1, u32 entity2, Vector<CollisionInfo>& collisions)
{
